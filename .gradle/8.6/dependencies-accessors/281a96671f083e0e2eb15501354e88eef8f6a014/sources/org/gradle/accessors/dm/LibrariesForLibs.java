...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        private final ComposeStylerLibraryAccessors laccForComposeStylerLibraryAccessors = new ComposeStylerLibraryAccessors(owner);
        private final ComposeUiLibraryAccessors laccForComposeUiLibraryAccessors = new ComposeUiLibraryAccessors(owner);

        public ComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>compose.styler</b>
         */
        public ComposeStylerLibraryAccessors getStyler() {
            return laccForComposeStylerLibraryAccessors;
        }
    ...
    public static class ComposeStylerLibraryAccessors extends SubDependencyFactory {

        public ComposeStylerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>desktop</b> with <b>com.mayakapps.compose:window-styler</b> coordinates and
         * with version reference <b>composeWindowsStyler</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDesktop() {
            return create("compose.styler.desktop");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>composeWindowsStyler</b> with value <b>0.3.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComposeWindowsStyler() { return getVersion("composeWindowsStyler"); }
